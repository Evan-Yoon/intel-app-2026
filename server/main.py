...
def random_animal():
    import random
    characteristics = ["귀여운", "빠른", "느린", "똑똑한"]
    animals = ["고양이", "강아지", "호랑이", "사자"]
    return {"animal":random.choice(animals), "characteristics":random.choice(characteristics)}